...
def test_edit_by_put(create_fun, put_fun, edited_data, get_fun, del_fun):
    create_fun.create_object(my_object=MY_OBJECT)
    put_fun.put_object(edited_data, create_fun.json['id'])
...
@pytest.mark.medium
def test_edit_by_putch(create_fun, patch_fun, get_fun, del_fun):
    create_fun.create_object(my_object=MY_OBJECT)
    patch_fun.patch_object(PATCHED_DATA, create_fun.json['id'])
...
@allure.feature('Homework 23')
def test_delete_object(create_fun, del_fun, get_fun):
    create_fun.create_object(my_object=MY_OBJECT)
    del_fun.del_object(create_fun.json['id'])
    del_fun.check_del_message(del_fun.json, create_fun.json['id'])
    get_fun.get_object_by_id(create_fun.json['id'])
    del_fun.check_not_found_message(get_fun.json, create_fun.json['id'])
